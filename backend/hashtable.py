...
'''
here is an example of what parsing a line will look like:
CSV Line: "Chanel No.5","Chanel","aldehydes,jasmine,rose,sandalwood","4.5"

After Parsing:
fields = [
    "Chanel No.5",
    "Chanel",
    "aldehydes,jasmine,rose,sandalwood",
    "4.5"
]
'''
